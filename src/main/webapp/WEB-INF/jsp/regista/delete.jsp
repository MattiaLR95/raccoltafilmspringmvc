			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<div class='card'>
						...
						<form:form modelAttribute="delete_regista_attr" method="post" action="${pageContext.request.contextPath}/regista/saveDelete/${delete_regista_attr.id}" class="row g-3" novalidate="novalidate">
