				...
				<div class="container">
					...
					<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<form:form modelAttribute="edit_film_attr"  method="post" action="${pageContext.request.contextPath }/film/edit" novalidate="novalidate" class="row g-3">
								<form:hidden path="id"/>
								...
								<div class="col-md-3">
									<label for="dataPubblicazione" class="form-label">Data Pubblicazione <span class="text-danger">*</span></label>
